...
rsconnect::setAccountInfo(name='mbstew',
                          token='8F81BE11C27F11F5E224A8D51663AF38',
                          secret='MMS3wKAmB6xlmj/Bo2HAD/htTnX38JWtvyUDCBmy')
library(rsconnect)

rsconnect::deployApp('/Users/mbstew/Documents/BYU 2020/Stat 495R')

# server.R code from shiny website
library(shiny)
library(ggplot2)
...
head(Shot_coordinate)
tail(Shot_coordinate)
summary(Shot_coordinate)


# Draw the court using R
